...

{
  ...
  *(undefined4 *)(param_1 + 0x940) = 0;
  ...
  memory_region_block_memory_load
            (*(undefined8 *)(*(long *)(nds_system + lVar16 + 0x31d43b8) + 0x1000000),lVar1,uVar3,
             (long)__src + (ulong)local_a08,uStack_9fc);
  memory_region_block_memory_load
            (*(undefined8 *)(*(long *)(nds_system + lVar16 + 0x31d43c0) + 0x1000000),lVar1,
  ...
  *(undefined4 *)(nds_system + lVar16 + 0x10ce10c) = uStack_a04;
  *(undefined4 *)(nds_system + lVar16 + 0x20d46fc) = local_9f4;
...
LAB_0016f978:
      ...
      if ((nds_system[lVar16 + 0x31d5e42] & 1) == 0) {
        gamecard_decrypt_secure_region(lVar2,local_a1c,lVar16 + 0x35e5980);
      }
      else {
...
LAB_0016f690:
  __snprintf_chk(auStack_828,0x820,1,0x820,"%s%cbackup%c%s.dsv",lVar16 + 0x8ab80,0x2f,0x2f,
                 lVar16 + 0x8b380);
...
LAB_0016f8ac:
  ...
  *(uint *)(polygon_sort_list_13776 + *(long *)(nds_system + lVar16 + 0x30d8930) + 0x151c4) = uVar10
  ;
  *(uint *)(*(long *)(nds_system + lVar16 + 0x30d8930) + 0x3ffc00) = uVar10;
  *(undefined2 *)(polygon_sort_list_13776 + *(long *)(nds_system + lVar16 + 0x30d8930) + 0x151c8) =
       local_82a;
  if (local_a84 < 2) {
    //iVar12 = gamecard_load_gba(param_1,lVar16 + 0x8b380);
    //if (iVar12 == -1) {
...
LAB_0016fb08:
      if (uVar4 < 0x2000001) {
        ...
        if (iVar12 == -1) {
          ...
          local_a84 = 2;
          memcpy(*(void **)(nds_system + lVar16 + 0x31d4368),__src,(ulong)uVar4);
        }
      }
      else {
        local_a84 = 0;
...

{
  ...
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15648) = lVar2;
  lVar2 = param_1[0xd5d1];
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15650) = param_1[0xd5d0];
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15658) = lVar2;
  lVar2 = param_1[0xd5d3];
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15660) = param_1[0xd5d2];
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15668) = lVar2;
  lVar2 = param_1[0xd5d5];
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15670) = param_1[0xd5d4];
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15678) = lVar2;
  lVar2 = param_1[0xd5d7];
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15680) = param_1[0xd5d6];
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15688) = lVar2;
  lVar2 = param_1[0xd5d9];
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15690) = param_1[0xd5d8];
  *(long *)(polygon_sort_list_13776 + lVar4 + 0x15698) = lVar2;
  ...
  if (*(ushort *)((long)param_1 + 0x14) == 0x105) {
    ...
    *param_1 = *param_1 + 1;
    ...
    if ((int)param_1[0x10b42] == 0) {
      ...
      video_3d_start_rendering((long)param_1, 0);
    }
    uVar9 = (uint)*(byte *)((long)param_1 + 0x35ef9a4);
  }
  else {
...

{
  ...
  *(undefined2 *)((long)param_1 + 0xd6e) = 0xffff;
  platform_set_default_controls((undefined8*)((char*)param_1 + 0x333 * sizeof(undefined4)),(undefined8*)puVar4);
